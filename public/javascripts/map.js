        ...
        layers: [
            ...
            new ol.layer.Tile({
                ...
                source: new ol.source.TileWMS({
                    url: 'https://192.168.1.3:8443/geoserver/duria/wms?service=WMS&version=1.1.0&request=GetMap&layers=duria:orto025&srs=EPSG:4326'
                }),
                name: 'TopoMap',
                alias: 'Ortofoto',
            ...
            new ol.layer.Tile({
                visible: true,
                source: new ol.source.TileWMS({
                    url: 'https://192.168.1.3:8443/geoserver/duria/wms?service=WMS&version=1.1.0&request=GetMap&layers=duria:topowebbkartan&srs=EPSG:4326'
                }),
                name: 'TopoMap',
